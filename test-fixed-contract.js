...
async function testFixedContract() {
  try {
    ...
    // Try to register a project with the correct parameters
    console.log("\n=== Testing Fixed Contract Call ===");
    try {
      const tx = await contract.registerProject(
        2,
        "Test Project Fixed",
        "A test project with fixed contract call",
        "https://github.com/example/test-project",
        "https://test-project-demo.example.com"
      );
      ...
      const updatedData = await contract.hackathons(2);
